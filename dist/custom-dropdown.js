...
var styles = ":host{display:block}.custom-select{position:relative;font-family:Arial}.custom-select select{display:none}.select-selected{padding:8px 16px;border:1px solid rgba(0,0,0,0);border-color:rgba(0,0,0,0) rgba(0,0,0,0) rgba(0,0,0,.1) rgba(0,0,0,0);cursor:pointer;user-select:none}.select-selected:after{position:absolute;content:\"\";top:14px;right:10px;width:0;height:0;border:6px solid rgba(0,0,0,0);border-color:#000 rgba(0,0,0,0) rgba(0,0,0,0) rgba(0,0,0,0)}.select-selected.select-arrow-active:after{border-color:rgba(0,0,0,0) rgba(0,0,0,0) #000 rgba(0,0,0,0);top:7px}.select-items{position:absolute;top:100%;left:0;right:0;z-index:99;background-color:#fff}.select-items div{padding:8px 16px;border:1px solid rgba(0,0,0,0);border-color:rgba(0,0,0,0) rgba(0,0,0,0) rgba(0,0,0,.1) rgba(0,0,0,0);cursor:pointer;user-select:none}.select-items div:hover{background-color:rgba(0,0,0,.1)}.select-hide{display:none}.same-as-selected{background-color:rgba(0,0,0,.1)}";
...
CustomDropdown.styles = i$5 `${r$5(styles)}`;
__decorate([
    n$1({ type: Array })
